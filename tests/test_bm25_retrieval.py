...
from avf.agents.retrieval import BM25Retriever  # noqa: E402
...
class BM25RetrieverTests(unittest.TestCase):
    ...
    def test_mock_memory_service_uses_bm25_for_memory_query_ranking(self) -> None:
        service = MockMemoryService(
            memory_backend=SQLiteMemory(),
            retrieval_module=BM25Retriever(),
        )
        service.call_tool(
            tool_call(
                "memory.write",
